...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model, sqs_len, max_len):
        ...
        # 如果d_model不是偶数，那么再d_model维度上需要减少1
        if self.d_model%2==1:
...
# transformer原始代码没有考虑输入x的batch_size大小，因此在设置pos_encoding中，self.encoding需要弄一个batch维度。
if __name__=="__main__":
    encoder_input = torch.randn(8, 512, 1024)
    pos = PositionalEncoding(1024, 512, 1024)
